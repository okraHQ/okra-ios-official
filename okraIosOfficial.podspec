...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of okraIosOfficial.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/nzeakokosi7/okraIosOfficial'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nzeakokosi7' => 'nzeakokosi7@gmail.com' }
  s.source           = { :git => 'https://github.com/nzeakokosi7/okraIosOfficial.git', :tag => s.version.to_s }
